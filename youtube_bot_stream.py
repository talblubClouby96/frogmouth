...
def main():
    ...
    channels = [
        "https://www.youtube.com/@Boymuscleworkout/videos",
        "https://www.youtube.com/@Boymuscleworkout2/videos"
    ]

    links = []
    target_count = random.randint(50, 200)  # Random target count between 50 and 200
    print(f"Targeting {target_count} unique links.")
    ...
    for channel in channels:
        ...
        while len(links) < target_count:
            ...
            print(f"Number of unique links from {channel}: {len(links)}")
            scroll_down(driver)
